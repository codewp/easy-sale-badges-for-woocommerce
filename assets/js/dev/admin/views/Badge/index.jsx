		...
		>
			<div className="asnp-relative">
				<div>
					...
					<div className="asnp-relative asnp-h-full asnp-w-full asnp-flex asnp-flex-col-reverse xl:asnp-flex-row">
						<div className="asnp-relative asnp-flex asnp-bg-white asnp-border-2 asnp-my-4">
