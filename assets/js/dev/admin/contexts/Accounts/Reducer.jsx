...
export const Action = {
	SET_ITEMS: 'account/setItems',
	ADD_ITEM: 'account/addItem',
	UPDATE_ITEM: 'account/updateItem',
	DELETE_ITEM: 'account/deleteItem',
	SET_IS_LOADING: 'account/setIsLoading',
	SET_LOADED: 'account/setLoaded',
};
...
export const fetchItems = async ( dispatch ) => {
	try {
		...
		let response = await AccountApi.getAccounts();
