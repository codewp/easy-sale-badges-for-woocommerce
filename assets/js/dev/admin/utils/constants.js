...
export default function BadgeCssandAdv( badge ) {
	...
	switch ( badge.badgeImage ) {
		...
		case 'sale6':
			...
			break;
		case 'bigSaleCir1':
			icon = 'bigSaleCir1.png';
			break;
		case 'bigSaleCir2':
			icon = 'bigSaleCir2.png';
			break;
		case 'bigSaleCir3':
			icon = 'bigSaleCir3.png';
			break;
		case 'bigSaleCir4':
			icon = 'bigSaleCir4.png';
			break;
		case 'bigSalBanneer1':
			icon = 'bigSalBanneer1.png';
			break;
		case 'bigSalBanneerr2':
			icon = 'bigSalBanneerr2.png';
			break;
		case 'bigSalBanneer3':
			icon = 'bigSalBanneer3.png';
			break;
		case 'bigSalBanneer4':
			icon = 'bigSalBanneer4.png';
			break;
		case 'bigSalBanneer5':
			icon = 'bigSalBanneer5.png';
			break;
		case 'bigSaleFont1':
			icon = 'bigSaleFont1.png';
			break;
		case 'bigSaleFont2':
			icon = 'bigSaleFont2.png';
			break;
		case 'bigSaleFont3':
			icon = 'bigSaleFont3.png';
			break;
		case 'bigSaleFont4':
			icon = 'bigSaleFont4.png';
			break;
		case 'bigSaleFont5':
			icon = 'bigSaleFont5.png';
			break;
		case 'hotSale1':
			icon = 'hotSale1.png';
			break;
		...
		case 'saleKind6':
			...
			break;
		case 'saleKindNew1':
			icon = 'saleKindNew1.png';
			break;
		case 'saleKindNew2':
			icon = 'saleKindNew2.png';
			break;
		case 'saleKindNew3':
			icon = 'saleKindNew3.png';
			break;
		case 'saleKindNew4':
			icon = 'saleKindNew4.png';
			break;
		case 'saleKind7':
			icon = 'saleKind7.png';
			break;
		...
		case 'saleHuge5':
			icon = 'saleHuge5.png';
			break;
		case 'percentageCircle1':
			icon = 'percentageCircle1.png';
			break;
		case 'percentageCircle2':
			icon = 'percentageCircle2.png';
			break;
		case 'percentageCircle3':
			icon = 'percentageCircle3.png';
			break;
		case 'percentageCircle4':
			icon = 'percentageCircle4.png';
			break;
		case 'percentageCircle5':
			icon = 'percentageCircle5.png';
			break;
		case 'percentageSale1':
			icon = 'percentageSale1.png';
			break;
		case 'percentageSale2':
			icon = 'percentageSale2.png';
			break;
		case 'percentageSale3':
			icon = 'percentageSale3.png';
			break;
		case 'percentageSale4':
			icon = 'percentageSale4.png';
			break;
		case 'percentageSale5':
			icon = 'percentageSale5.png';
			break;
		case 'percentageSale6':
			icon = 'percentageSale6.png';
			break;
		case 'percentageSale7':
			icon = 'percentageSale7.png';
			break;
		case 'percentageSale8':
			icon = 'percentageSale8.png';
			break;
		case 'percentageSale9':
			icon = 'percentageSale9.png';
			break;
		case 'percentageSale10':
			icon = 'percentageSale10.png';
			break;
		case 'percentageSale11':
			icon = 'percentageSale11.png';
			break;
		case 'percentageSale12':
			icon = 'percentageSale12.png';
			break;
		case 'percentage1':
			icon = 'percentage1.png';
			break;
		case 'percentage2':
			icon = 'percentage2.png';
			break;
		case 'percentage3':
			icon = 'percentage3.png';
			break;
		case 'percentage4':
			icon = 'percentage4.png';
			break;
		case 'perBanner1':
			icon = 'perBanner1.png';
			break;
		...
		case 'perBanner3':
			...
			break;
		case 'bannerPerc1':
			icon = 'bannerPerc1.png';
			break;
		case 'bannerPerc2':
			icon = 'bannerPerc2.png';
			break;
		case 'bannerPerc3':
			icon = 'bannerPerc3.png';
			break;
		case 'bannerPerc4':
			icon = 'bannerPerc4.png';
			break;
		case 'bannerPerc5':
			icon = 'bannerPerc5.png';
			break;
		case 'bannerPerc6':
			icon = 'bannerPerc6.png';
			break;
		case 'bannerPerc7':
			icon = 'bannerPerc7.png';
			break;
		case 'bannerPerc8':
			icon = 'bannerPerc8.png';
			break;
		case 'bannerPerc9':
			icon = 'bannerPerc9.png';
			break;
		case 'bannerPerc10':
			icon = 'bannerPerc10.png';
			break;
		case 'bannerPerc11':
			icon = 'bannerPerc11.png';
			break;
		case 'bannerPerc12':
			icon = 'bannerPerc12.png';
			break;
		case 'perc1':
			icon = 'perc1.png';
			break;
		...
		case 'preoOrder9':
			...
			break;
		case 'preoOrder10':
			icon = 'preoOrder10.png';
			break;
		case 'preoOrder11':
			icon = 'preoOrder11.png';
			break;
		case 'preoOrder12':
			icon = 'preoOrder12.png';
			break;
		case 'preoOrder13':
			icon = 'preoOrder13.png';
			break;
		case 'preoOrder14':
			icon = 'preoOrder14.png';
			break;
		case 'preoOrder15':
			icon = 'preoOrder15.png';
			break;
		case 'free1':
			icon = 'free1.png';
			break;
		...
		case 'badgeValen8':
			...
			break;
		case 'badgeValen9':
			icon = 'badgeValen9.png';
			break;
		case 'badgeValen10':
			icon = 'badgeValen10.png';
			break;
		case 'badgeValen11':
			icon = 'badgeValen11.png';
			break;
		case 'badgeValen12':
			icon = 'badgeValen12.png';
			break;
		case 'badgeValen13':
			icon = 'badgeValen13.png';
			break;
		case 'badgeValen14':
			icon = 'badgeValen14.png';
			break;
		case 'badgeValen15':
			icon = 'badgeValen15.png';
			break;
		case 'badgeValen16':
			icon = 'badgeValen16.png';
			break;
		case 'badgeValen17':
			icon = 'badgeValen17.png';
			break;
		case 'badgeValen18':
